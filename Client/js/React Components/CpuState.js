        ...
        <div className="outer-container row grey">
          <div className="row">
            <div className="inner-container col-lg-8 col-md-10 col-sm-12 col-xs-12">
              <h2>About MOES:GBA</h2>
              <p>MOES Gameboy Advance Emulator is currently unfinished. Until more progress is made you can execute ROM files here on the ARM7TDMI (GBA CPU) Simulator being used as the emulators core. Please send me an email if you find any bugs or need to get in contact for any reason.</p>
            </div>
          </div>
        </div>
      );
